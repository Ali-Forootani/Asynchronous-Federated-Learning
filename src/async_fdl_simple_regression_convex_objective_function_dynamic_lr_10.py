...
# -*- coding: utf-8 -*-
"""
Asynchronous Federated Learning with Dynamic Delay Tracking and Random Client Selection (Non-IID Data)
"""
...
async def federated_learning_async(clients_models, server_model, clients_dataloaders, total_updates=100, local_epochs=1,
    ...
    delay_t = 0  # Initial delay_t for the first round
    ...
    print("Execution times by round:", execution_times_by_round)
    return server_model, server_losses, client_losses_record, execution_times_by_round
...
async def main():
    ...
    server_model, server_losses, client_losses_record, execution_times_by_round = await federated_learning_async(
