...
prefix = "server_losses_clients_10_epochs_50_updates"
...
if data_list:
    ...
    plt.title("Server Loss During AFL - Total Client: 10, Client Fraction: 20.0% - 90.0%",
              fontsize=18,)
    ...
    plt.savefig("regression_server_loss_plot.png", dpi=300, bbox_inches='tight')  # Save with tight bounding box
