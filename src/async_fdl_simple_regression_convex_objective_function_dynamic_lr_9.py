...
# -*- coding: utf-8 -*-
"""
Created on Sat Jan 11 15:08:45 2025
...
# -*- coding: utf-8 -*-
"""
Asynchronous Federated Learning with Random Client Selection and Immediate Updates (Non-IID Data)
"""
...
async def federated_learning_async(clients_models, server_model, clients_dataloaders, total_updates=100, local_epochs=1,
    ...
    while global_updates < total_updates:
        ...
        # Update the server model immediately after receiving each client's update
        for i, (state_dict, client_losses) in zip(selected_clients, results):
            ...
            if global_updates >= total_updates:
                break  # Stop if total updates are reached

        # Calculate server loss after the updates
        total_loss = 0
